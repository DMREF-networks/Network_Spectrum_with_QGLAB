...
2 - A .txt file containing the pairs indices of vertices that make of the edges of the network generated by NetGen.py placed in the configs/edgelists directory.\
